...
var publicInterface = {
  ...
  uploadFile: function (url, data, headers, filePath, name, success, failure) {
    return publicInterface.sendRequest(url, { method: 'upload', data: data, headers: headers, filePaths: [ filePath ], name: name }, success, failure);
  },
